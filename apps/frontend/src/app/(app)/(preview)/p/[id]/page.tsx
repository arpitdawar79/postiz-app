        ...
        <div className="flex-1">
          <div className="gap-[20px] flex flex-col">
            {post.map((p: any, index: number) => (
              <div
                key={String(p.id)}
                className="relative px-4 py-4 border bg-third border-tableBorder"
              >
                <div className="flex space-x-3">
                  <div>
                    <div className="relative flex rounded-full shrink-0 h-30 w-30">
                      ...
                      <div className="absolute -end-[5px] -bottom-[5px] w-[30px] h-[30px] z-[20]">
                        <img
                          className="w-full h-full bg-black rounded-full aspect-square border-tableBorder"
